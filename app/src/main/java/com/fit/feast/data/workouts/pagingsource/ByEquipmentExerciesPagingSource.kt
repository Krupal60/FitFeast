...
class ByEquipmentExerciesPagingSource(private val equipment: String, private val apiService: FitnessApiService) :
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Exercises> {
        return try {
            ...
            val data = apiService.byBodyParts(url = "/exercises/equipment/$equipment",limit = 15, page = currentPage)
            LoadResult.Page(
