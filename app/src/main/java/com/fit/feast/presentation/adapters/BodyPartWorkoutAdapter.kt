...
class BodyPartWorkoutAdapter(private val onCardClick: (Exercises) -> Unit) :
    PagingDataAdapter<Exercises, BodyPartWorkoutAdapter.ExerciseViewHolder>(ExerciseDiffCallback) {
